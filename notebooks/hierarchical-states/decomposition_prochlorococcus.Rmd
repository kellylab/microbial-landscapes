...
All depths have about the same compositional variability.
```{r}
ggplot(bats.div, aes(x = distance)) +
...
Shallower depths are much more stable in composition.
This is notably different from BATS.
```{r}
